...
const
  ...
  EDITBONE_TITLE_BAR_SCALE_MODE = 3;
  EDITBONE_TITLE_BAR_SPACING1 = 4;
  EDITBONE_TITLE_BAR_ENCODING = 5;
  EDITBONE_TITLE_BAR_SPACING2 = 6;
  EDITBONE_TITLE_BAR_HIGHLIGHTER = 7;
  EDITBONE_TITLE_BAR_SPACING3 = 8;
  EDITBONE_TITLE_BAR_COLORS = 9;
  EDITBONE_TITLE_BAR_SPACING4 = 10;
